...
static sun3_long_instruction sun3_instr_add_reg_long = {
	0, 
	0,
	0,
...
void sun3_add_reg_long(sun3 *vm)
{
	...
	sun3_ea_mode_read_long(vm, &sun3_instr_add_reg_long);
	src= sun3_instr_add_reg_long.src;
	ans= dest+src;
...
static void sun3_instr_add_ea_long_execute(sun3_long_instruction * add)
{
...
static void sun3_instr_add_ea_long_set_flags(sun3_long_instruction * add, sun3_sr * sr)
{
	sun3_sr_set_v(*sr, ( (  sun3_unsigned_long_sign(add->src)
			    &  sun3_unsigned_long_sign(add->dest)
			    & (!sun3_unsigned_long_sign(add->ans))
			    )
			  | ( (!sun3_unsigned_long_sign(add->src))
			    & (!sun3_unsigned_long_sign(add->dest))
			    &  sun3_unsigned_long_sign(add->ans)
			    )
			  ));
	sun3_sr_set_c(*sr, ( (  sun3_unsigned_long_sign(add->src)
			    &  sun3_unsigned_long_sign(add->dest)
			    )
			  | ( (!sun3_unsigned_long_sign(add->ans))
			    &  sun3_unsigned_long_sign(add->dest)
	...
	sun3_sr_set_n(*sr, ((sun3_signed_long)add->ans)<0);
}


static sun3_long_instruction sun3_instr_add_ea_long = {
	0,
	0,
	0,
	sun3_ea_mode_ari|sun3_ea_mode_aripi|sun3_ea_mode_aripd
	|sun3_ea_mode_arid|sun3_ea_mode_arii|sun3_ea_mode_asa|sun3_ea_mode_ala,
	sun3_instr_add_ea_long_execute,
	sun3_ea_mode_ari|sun3_ea_mode_aripi|sun3_ea_mode_aripd
	|sun3_ea_mode_arid|sun3_ea_mode_arii|sun3_ea_mode_asa|sun3_ea_mode_ala,
	sun3_instr_add_ea_long_set_flags
};


void sun3_add_ea_long(sun3 *vm)
{
	unsigned int src_reg= sun3_instr_move_reg(vm->pci);
	sun3_instr_add_ea_long.src= sun3_data_regs_read_unsigned_long(&vm->data_regs, src_reg);
	sun3_ea_mode_rw_long(vm, &sun3_instr_add_ea_long);
}
