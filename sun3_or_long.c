...
sun3_long_instruction sun3_instr_or_reg_long = {
...
void sun3_or_reg_long(sun3 *vm)
{
	...
	sun3_ea_mode_read_long(vm, &sun3_instr_or_reg_long);
	src = sun3_instr_or_reg_long.src;
	ans = dest|src;
...
static void sun3_instr_or_ea_long_execute(sun3_long_instruction * or)
{
...
static void sun3_instr_or_ea_long_set_flags(sun3_long_instruction * or, sun3_sr * sr)
{
...
static sun3_long_instruction sun3_instr_or_ea_long = {
	...
	.execute = sun3_instr_or_ea_long_execute,
	...
	.set_flags = sun3_instr_or_ea_long_set_flags
};


void sun3_or_ea_long(sun3 *vm)
{
	unsigned int src_reg = sun3_instr_move_reg(vm->pci);
	sun3_instr_or_ea_long.src = sun3_data_regs_read_unsigned_long(&vm->data_regs, src_reg);
	sun3_ea_mode_rw_long(vm, &sun3_instr_or_ea_long);
}
