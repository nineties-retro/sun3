...
sun3_word_instruction sun3_instr_and_reg_word =
{ 0
, 0
, 0
...
void sun3_and_reg_word(sun3 *vm)
{
	...
	sun3_ea_mode_read_word(vm, &sun3_instr_and_reg_word);
	src= sun3_instr_and_reg_word.src;
	ans= dest&src;
...
static void sun3_instr_and_ea_word_execute(sun3_word_instruction *or)
{
...
static void sun3_instr_and_ea_word_set_flags(sun3_word_instruction *or, sun3_sr *sr)
{
...
static sun3_word_instruction sun3_instr_and_ea_word =
{ 0
, 0
, 0
, sun3_ea_mode_ari|sun3_ea_mode_aripi|sun3_ea_mode_aripd
  |sun3_ea_mode_arid|sun3_ea_mode_arii|sun3_ea_mode_asa|sun3_ea_mode_ala
, sun3_instr_and_ea_word_execute
, sun3_ea_mode_ari|sun3_ea_mode_aripi|sun3_ea_mode_aripd
  |sun3_ea_mode_arid|sun3_ea_mode_arii|sun3_ea_mode_asa|sun3_ea_mode_ala
, sun3_instr_and_ea_word_set_flags
};


void sun3_and_ea_word(sun3 *vm)
{
	unsigned int src_reg= sun3_instr_move_reg(vm->pci);
	sun3_instr_and_ea_word.src= sun3_data_regs_read_unsigned_word(&vm->data_regs, src_reg);
	sun3_ea_mode_rw_word(vm, &sun3_instr_and_ea_word);
}
