...
static void sun3_instr_eor_byte_execute(sun3_byte_instruction * eor)
{
...
static void sun3_instr_eor_byte_set_flags(sun3_byte_instruction * eor, sun3_sr * sr)
{
...
sun3_byte_instruction sun3_instr_eor_byte = {
	...
	.execute = sun3_instr_eor_byte_execute,
	...
	.set_flags = sun3_instr_eor_byte_set_flags
};
