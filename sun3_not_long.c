...
static void sun3_instr_not_long_execute(sun3_long_instruction * not)
{
	not->ans= ~not->dest;
}
...
static void sun3_instr_not_long_set_flags(sun3_long_instruction * not, sun3_sr * sr)
{
	sun3_sr_set_n(*sr, sun3_unsigned_long_sign(not->ans));
...
sun3_long_instruction sun3_instr_not_long = {
	...
	.execute = sun3_instr_not_long_execute,
	...
	.set_flags = sun3_instr_not_long_set_flags
};
