...
sun3_byte_instruction sun3_instr_or_reg_byte = {
...
void sun3_or_reg_byte(sun3 *vm)
{
	...
	sun3_ea_mode_read_byte(vm, &sun3_instr_or_reg_byte);
	src = sun3_instr_or_reg_byte.src;
	ans = dest|src;
...
static void sun3_instr_or_ea_byte_execute(sun3_byte_instruction * or)
{
...
static void sun3_instr_or_ea_byte_set_flags(sun3_byte_instruction * or, sun3_sr * sr)
{
...
static sun3_byte_instruction sun3_instr_or_ea_byte = {
	...
	.execute = sun3_instr_or_ea_byte_execute,
	...
	.set_flags = sun3_instr_or_ea_byte_set_flags
};


void sun3_or_ea_byte(sun3 *vm)
{
	unsigned int src_reg = sun3_instr_move_reg(vm->pci);
	sun3_instr_or_ea_byte.src = sun3_data_regs_read_unsigned_byte(&vm->data_regs, src_reg);
	sun3_ea_mode_rw_byte(vm, &sun3_instr_or_ea_byte);
}
